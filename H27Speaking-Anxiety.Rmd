...
#Read the data
```{r}
april<-read.csv("H27_speaking-anxiety_April.csv",header=T,sep=",")
july<-read.csv("H27_speaking-anxiety_July.csv",header=T,sep=",")
big5<-read.csv("H27_BIG5_results.csv",header=T,sep = ",")
```
...
```{r,eval=F,include=F}
cbind(apply(imp_list$april$avoid,1,mean),apply(imp_list$july$avoid,1,mean))
